...
{   
    ...
    public int Integer1 = 3;    //create 5 wholenumber-variables
    public int Integer2 = 7;
    public int Integer3 = 11;
    public int Integer4 = 6;
    public int Integer5 = 25;
    ...
    void Start()
    {
        ...
        Float1 = (Integer1 + Integer2 + Integer3 + Integer4 + Integer5)/3;    //calculations (sum of three integers divided by 3) 
